  ...
  return (
    <article className="container bg-white shadow-md h-full w-full max-w-[1200px] px-5 lg:px-24 py-5 space-y-5">
      ...
      <div className="space-y-3">
        ...
        <Image src="/images/png/FERectangle.png" alt="" width="100%" height="auto" className="my-[30px]" />
        <div>
          <TypographyH2 fontFamily="barlow" fontWeight="bold" fontSize="20px">
          ...
          <Paragraph fontSize="18px" fontColor="#212121" textPosition="justify">
            <ol className="list-decimal list-inside">
              <li>
                Tugas dan tanggung jawab<br></br>
                <Paragraph>
                  Tugas seorang <u>frontend developer</u> adalah membuat desain tampilan visual aplikasi, meliputi layout, warna, tipografi, grafik, dan sebagainya. Selain itu, mereka juga bertanggung jawab untuk memastikan aplikasi tetap
