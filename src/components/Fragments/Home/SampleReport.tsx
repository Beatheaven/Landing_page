      ...
      <div className="container flex flex-col lg:flex-row justify-around">
        ...
        <div className="space-y-5 w-full lg:w-[22rem]">
          ...
          <div>
            ...
            <p className="font-roboto text-[15px]">Your customized Clift on Strengths reports and guides will give you an "aha" moment as you experience new ways to understand what makes you so unique.</p>
          </div>
