      ...
      <div className="container flex flex-col lg:flex-row-reverse justify-around  ">
        ...
        <div className="space-y-5 w-full lg:w-[22rem]">
          ...
          <div>
            ...
            <p className="font-roboto text-[15px]">Now it's time to aim your Clift on Strengths at anything that comes your way. Use our resources and tools to better aim your strengths at success.</p>
          </div>
