      ...
      <div className="container p-10 lg:p-16">
        <div className="flex flex-col lg:flex-row">
          <figure className="flex justify-center">
            <img src="/images/png/Technology.png" className="my-5 lg:my-0 w-full max-w-xl bg-slate-300 rounded-md mr-5 lg:mr-5 object-cover object-top" alt="Sagara" />
          </figure>
          ...
          <div className="space-y-5 md:space-y-5 lg:space-y-16 flex flex-col justify-center">
            <p className="font-roboto-flex font-extrabold text-3xl lg:text-[40px] leading-tight">
              <span className="text-[#A51535]">Ratusan</span> Pengembang dalam Program Sertifikasi IT Sagara untuk Berkembang di Tempat Kerja dan di Mana Saja Lain.
            </p>
            <div className="font-roboto-flex">
              <p className=" font-extrabold text-3xl lg:text-[40px] leading-tight text-[#A51535]">
